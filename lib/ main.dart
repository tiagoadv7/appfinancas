...
Map<String, IconData> iconMap = {
  'Painel': Icons.dashboard,
  'SetaCima': Icons.arrow_upward,
  'SetaBaixo': Icons.arrow_downward,
  'Cifrão': Icons.attach_money,
  'CarrinhoCompras': Icons.shopping_cart,
  'Casa': Icons.home,
  'Carro': Icons.directions_car,
  'Talheres': Icons.restaurant,
  'Maleta': Icons.work,
  'Escudo': Icons.security,
  'Porquinho': Icons.savings,
  'Engrenagem': Icons.settings,
  'Usuarios': Icons.people,
  'Lixeira': Icons.delete,
  'Mais': Icons.add,
  'X': Icons.close,
  'ListaVerificacao': Icons.checklist,
  'ArquivoLinhas': Icons.description,
  'GraficoPizza': Icons.pie_chart,
  'CartaoCredito': Icons.credit_card,
  'EdificioColunas': Icons.account_balance,
  'BombaGasolina': Icons.local_gas_station,
  'Escola': Icons.school,
  'Filme': Icons.movie,
  'Futebol': Icons.sports_soccer,
  'Aviao': Icons.flight,
  'Hotel': Icons.hotel,
  'Telefone': Icons.phone,
  'Wifi': Icons.wifi,
  'Cachorro': Icons.pets,
  'Criancas': Icons.child_care,
  'Halter': Icons.fitness_center,
  'Musica': Icons.music_note,
  'Paleta': Icons.palette,
  'Camera': Icons.camera_alt,
  'Computador': Icons.computer,
  'Fones': Icons.headphones,
  'Controle': Icons.gamepad,
  'GuardaSol': Icons.beach_access,
  'Talheres2': Icons.restaurant_menu,
  'Xicara': Icons.coffee,
  'CopoMartini': Icons.local_bar,
  'BolsaCompras': Icons.shopping_bag,
  'Presente': Icons.card_giftcard,
  'Recibo': Icons.receipt,
  'Dinheiro': Icons.money,
  'Porquinho2': Icons.savings,
  'SetaCimaTendencia': Icons.trending_up,
  'SetaBaixoTendencia': Icons.trending_down,
};
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (widget.isAdmin)
          ListTile(
            leading: const Icon(Icons.group_outlined, color: primaryColor),
